...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class AddDog extends MyApiRequest<com.example.adampodraza.myapplication.backend.myApi.model.Dog> {

    private static final String REST_PATH = "createDog/{dog_id}/{email}";
    ...
    protected AddDog(java.lang.Long dogId, java.lang.String email) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.adampodraza.myapplication.backend.myApi.model.Dog.class);
